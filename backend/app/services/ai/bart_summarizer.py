...
class BARTSummarizer:
    """
    BART model for abstractive contract summarization
    """
    ...
    def __init__(self, model_name: str = "facebook/bart-large-cnn"):
        ...
        self.tokenizer = None
        self.model = None
        logger.info(f"Initializing BART summarizer with {model_name}")
    ...
    def generate_summary(
        ...
        # Tokenize input (BART has max 1024 tokens)
        ...
        logger.info(f"BART summary generated: {summary_words} words (compression: {compression_ratio:.2f}x)")
